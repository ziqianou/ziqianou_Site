        ...
        !(function (e, n) {
          ...
          var e,
            n = (function () {
              ...
              function R(t) {
                return (
                  M(t) && !F(t) && Object.getPrototypeOf(t) == Object.prototype
                );
              }
              ...
              return (
                ...
                (O.fragment = function (t, n, i) {
                  var o, a, s;
                  return (
                    v.test(t) && (o = r(f.createElement(RegExp.$1))),
                    o ||
                ...
                (O.init = function (t, n) {
                  ...
                  if ("string" == typeof t)
                    if ("<" == (t = t.trim())[0] && m.test(t))
                      (i = O.fragment(t, RegExp.$1, n)), (t = null);
                    else {
                    ...
                    if (D(t))
                      ...
                      (i = O.fragment(t.trim(), RegExp.$1, n)), (t = null);
                    else {
                      if (n !== e) return r(n).find(t);
                      i = O.qsa(f, t);
                    }
                ...
                ((r = function (t, e) {
                  ...
                  return (
                    "boolean" == typeof t && ((r = t), (t = i.shift())),
                ...
                (r.each = function (t, e) {
                  ...
                  if (Z(t)) {
                    ...
                    for (r in t) if (!1 === e.call(t[r], r, t[r])) return t;
                  return t;
                }),
                (r.grep = function (t, e) {
                  return c.call(t, e);
                ...
                (r.fn = {
                  ...
                  each: function (t) {
                    return (
                      s.every.call(this, function (e, n) {
                  ...
                  closest: function (t, e) {
                    ...
                    return (
                      this.each(function (r, o) {
                        for (
                          ;
                          o && !(i ? i.indexOf(o) >= 0 : O.matches(o, t));
                  ...
                  attr: function (t, r) {
                    ...
                    return "string" != typeof t || 1 in arguments
                      ? this.each(function (e) {
                          if (1 === this.nodeType)
                            if (M(t)) for (n in t) U(this, n, t[n]);
                            else
            ...
            (function (e) {
                ...
                r.split(/\s/).forEach(function (r) {
                  ...
                  (s.proxy = function (e) {
                    if (!(e = T(e)).isImmediatePropagationStopped()) {
                      ...
                      return (
                        !1 === r && (e.preventDefault(), e.stopPropagation()), r
                      );
                    }
                  }),
                    (s.i = p.length),
                    ...
                    "addEventListener" in t &&
                      t.addEventListener(v(s.e), s.proxy, m(s, c));
                });
              }
                  ...
                  p(t, e, n, r).forEach(function (e) {
                    delete s[o][e.i],
                      "removeEventListener" in t &&
                        t.removeEventListener(v(e.e), e.proxy, m(e, i));
                  });
                });
              }
              ...
              (e.fn.delegate = function (t, e, n) {
                      ...
                      h.each(function (n, o) {
                        c &&
                          ...
                          r &&
                            (f = function (t) {
                              var n,
                                a = e(t.target).closest(r, o).get(0);
                              if (a && a !== o)
                                return (
                                  (n = e.extend(w(t), {
                                    currentTarget: a,
                ...
                (e.fn.trigger = function (t, n) {
                  return (
                    ((t =
                      a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))._args =
                      n),
                    this.each(function () {
              ...
              (h.href = t.location.href),
                ...
                (e.ajax = function (i) {
                  ...
                  !(function (t) {
                    ...
                    b.crossDomain ||
                      (((a = o.createElement("a")).href = b.url),
                      (a.href = a.href),
                      (b.crossDomain =
                        h.protocol + "//" + h.host !=
                        a.protocol + "//" + a.host)),
                      ...
                      t.processData &&
                        ...
                        !t.data ||
                          (t.type &&
                            ...
                            "jsonp" != t.dataType) ||
                          ((t.url = x(t.url, t.data)), (t.data = void 0));
                    })(b);
                  var j = b.dataType,
                    T = /\?.+=\?/.test(b.url);
                  if (
                  ...
                  if (
                    ...
                    return P.abort(), v(null, "abort", P, b, E), P;
                  var D = !("async" in b) || b.async;
                  if (
                    (P.open(b.type, b.url, D, b.username, b.password),
                    b.xhrFields)
                  )
    ...
    Bb20: [
      function (require, module, exports) {
        ...
        function change_slogan() {
          ...
          //     "谁还没个低谷期啊，我低谷期的时候连谷底的蚂蚁都嫌我穷！",
          //     "我不是在熬夜，我只是在和月亮约会，顺便帮它数星星",
          //     "我这人吧，脾气特别好，只要你不惹我，我最多就骂你两句",
          //     "我今天特别倒霉，早上出门踩到了狗屎，结果狗居然还追了我一路",
          //     "我最近在减肥，效果特别明显，镜子都快认不出我了",
          //     "我最近在研究哲学，研究怎么把被子叠成豆腐块，结果研究出了一个被子形状的豆腐",
          //     "驴一天啥事不干，净踢你脑袋了",
          //     "人类进化的时候，你躲起来了吧",
          //     "你就像那美羊羊，三千多集找不到娘",
          //     "百度你搜不到，你搜狗一定可以",
          //     "据我所知，我一无所知",
          //     "关于明天的事，你明天就会知道，不用等到后天",
          //     "中国有句古话，叫做有句古话说得妙",
          //     "为什么要说我懒，我明明什么都没做",
          //     "我知道你出发点是好的，但你先别出发",
          //     "看似很危险，其实一点也不安全",
          ...
          //     "想让我道歉可以，但是你得跪着听",
          //     "让你指点指点，不是让你指指点点",
          //     "新学到一句鼓励的话:对得起自己就好，剩下的交给报应吧。",
          //     "我洗了蒜了，水又水不着，痴又痴不保，一添添滴孩再百烂，孩类得钥匙~",
          //     "我就这样坐着，生活给我什么我就接着，拿走什么我就看着。",
          //     "明天能做的为什么要今天做❓",
          //     "虽然我知道这样很不好❌但是我就这样»»»",
          //     "我的一天：摆烂2️⃣3️⃣小时5️⃣9️⃣分钟5️⃣5️⃣秒，愧疚5️⃣秒",
          //     "⌓‿⌓人生不摆烂快乐少一半",
          //     "对得起自己就好剩下的交给报应吧🍦≋≋",
          //     "世上🈚难事只要肯放弃🐾",
          //     "🤙🏻👣努力扩大舒适圈⭕",
